...
public class chat extends AppCompatActivity implements AIListener{
    ListView mlista;
    EditText editText;
    Button btn_send_message, btn_voice;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_send_message = (Button) findViewById(R.id.keyboard);
                    ...
                    new AsyncTask<AIRequest, Void, AIResponse>() {
                        ...
                        protected void onPostExecute(AIResponse aiResponse) {
                            if(aiResponse != null){
                                ...
                                AdapMessage adap2 = new AdapMessage(lista, chat.this);
                                mlista.setAdapter(adap2);
                            }
                        }
                    }.execute(aiRequest);
    ...
    public void onResult(AIResponse result) {
        ...
        final AdapMessage adap = new AdapMessage(lista, this);
